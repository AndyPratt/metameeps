              ...
              <div className="flex items-center gap-2 flex-wrap mb-3">
                {character.configurations[0] ? (
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-muted rounded-md text-[11px] font-medium text-muted-foreground">
                    ...
                    {character.configurations[0].platform}
                  </span>
                ) : (
                  <span className="text-[11px] text-muted-foreground italic">No workstream assigned</span>
                )}
          ...
          <table className="w-full min-w-[700px]">
            <thead>
              <tr className="bg-muted text-left">
                ...
                <th className="px-4 py-3 text-xs font-medium text-muted-foreground">Workstream</th>
